...
This is the Privacy Policy of Defsolution (“Defsolution.io”). This policy applies to all Defsolution software applications, websites, and related services.
...
How Defsolution Collects Information
Defsolution may use the following different methods to receive and collect your information:
1. Account registration. When registering a Defsolution account, the system will ask you to provide information so that we can record you as the owner of the Defsolution product, which will help us provide you with services and information.
2. Product use, when you visit our website or log in to the Defsolution client, we will need enough information to complete your operation, and our server will automatically collect and aggregate information about your visit. The collected information may include the information of the login person's Defsolution account, access IP, operating system, browser type, etc.
...
Purpose of Information Collected by Defsolution
...
We primarily use your Personal Information to help us provide a better experience for you on our Website and to provide you with the Services and/or information you may have requested, such as using some features of our Website.
...
- Subscribing to our Service, and newsletters, uploading or submitting any material through Defsolution, or requesting any information;
...
Contacts 
If you have any questions about this statement or any privacy issues in our applications or services, feel free to contact us by sending mail to business@defsolution.io.`;
